...
public class GameBoard {
    ...
    final static float boardYOffset = 49.5f;

    public enum BoardLocations {
        A1(new Vector2f(X_AXIS_BOARD_START + boardXOffset, Y_AXIS_BOARD_START + boardYOffset),
                new Vector2i(0, 0)),
        A2(new Vector2f(X_AXIS_BOARD_START + boardXOffset, Y_AXIS_BOARD_START + boardYOffset + BOX_HEIGHT_F),
                new Vector2i(0, 1)),
        A3(new Vector2f(X_AXIS_BOARD_START + boardXOffset, Y_AXIS_BOARD_START + boardYOffset + (2 * BOX_HEIGHT_F)),
                new Vector2i(0, 2)),
        A4(new Vector2f(X_AXIS_BOARD_START + boardXOffset, Y_AXIS_BOARD_START + boardYOffset + (3 * BOX_HEIGHT_F)),
                new Vector2i(0, 3)),
        A5(new Vector2f(X_AXIS_BOARD_START + boardXOffset, Y_AXIS_BOARD_START + boardYOffset + (4 * BOX_HEIGHT_F)),
                new Vector2i(0, 4)),
        A6(new Vector2f(X_AXIS_BOARD_START + boardXOffset, Y_AXIS_BOARD_START + boardYOffset + (5 * BOX_HEIGHT_F)),
                new Vector2i(0, 5)),
        A7(new Vector2f(X_AXIS_BOARD_START + boardXOffset, Y_AXIS_BOARD_START + boardYOffset + (6 * BOX_HEIGHT_F)),
                new Vector2i(0, 6)),
        A8(new Vector2f(X_AXIS_BOARD_START + boardXOffset, Y_AXIS_BOARD_START + boardYOffset + (7 * BOX_HEIGHT_F)),
                new Vector2i(0, 7)),
        ...
        public static BoardLocations getEnumByPosition(Vector2f position) {
            for (BoardLocations location : values())
                if (location.getPosition().equals(position))
                    return location;
            return null;
        }
